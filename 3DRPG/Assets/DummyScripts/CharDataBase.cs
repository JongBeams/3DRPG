...
public class CharDataBase : MonoBehaviour
{
    ...
    //    //아이템 정보
    //    AddItem(0, "빈 아이템", 0, 0, 0, "", 0);
    //    AddItem(1, "검", 10, 0, 0, "Texture/Sword", 1);
    //    AddItem(2, "방패", 0, 5, 0, "Texture/Shield", 2);
    ...
    //    //플레이어 캐릭터
    //    AddPlayer(0, "기사",2,5,250,1000,4,3,6,6,7,8,9,10,15,30,10,10,"Prefabs/Character/Player");
    //    //AI동료 캐릭터
    ...
    //    AddPartner(3,"마법사", 10, 5, 150, 1000, 4, 3, 9, 0, 16, 17, "Prefabs/Magician");
    //    //적 캐릭터
    //    AddEnemy(10,"붉은 용", 10, 0, 1500, 8,8, 11, 12, 13, 14, "Prefabs/Character/Enemy");
    ...
    //    AddSkill(14,"용_화염숨결",1.5f,0,0,0, "Prefabs/SkillEffect/FireBreath", 1 << (LayerMask.NameToLayer("Player")) | 1 << (LayerMask.NameToLayer("Partner")), 15,2,11,1);
    ...
    //    AddSkill(17, "마법사_화염숨결", 10f, 0, 7, 80, "Prefabs/SkillEffect/FireBreath", 1 << (LayerMask.NameToLayer("Enemy")), 15, 2, 11, 1);
