...
public class Player_Dynamics : MonoBehaviour
{
    ...
    public int m_nIdentityPoint = 30;
    public int m_nIdentityPointtMax = 30;
    ...
    */
    ...
    bool Attack()
    {
        ...
        if (animator.GetCurrentAnimatorStateInfo(0).IsName("Idle_SwordShield") || animator.GetCurrentAnimatorStateInfo(0).IsName("Run_SwordShield"))
        {
            ...
            if (hitcol.Length != 0)
            {
                hitcol[0].GetComponent<Enemy_Ctrl>().GetDamage(CharStatus.getATK());
    ...
    bool ShieldBash()
    {
        ...
        if (animator.GetCurrentAnimatorStateInfo(0).IsName("Idle_SwordShield") || animator.GetCurrentAnimatorStateInfo(0).IsName("Run_SwordShield"))
        {
            ...
            if (hitcol.Length != 0)
            {
                hitcol[0].GetComponent<Enemy_Ctrl>().GetDamage((int)(m_nIdentityPoint / 3));
                //Debug.Log(hitcol[0].GetComponent<Enemy_Ctrl>().m_nEnemy_HP);
            }
