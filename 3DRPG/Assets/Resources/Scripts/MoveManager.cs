...
public static class MoveManager 
{
    ...
    static bool HealerMoving(int _id,Char_Status _CS)
    {
        ...
        // 타겟과의 거리
        Vector3 vecEnemyLookingPoint = new Vector3(CS.getObjTarget().transform.position.x, CS.gameObject.transform.position.y, CS.getObjTarget().transform.position.z);
    ...
    static bool MagicianMoving(int _id, Char_Status _CS)
    {
        //파트너 정보
        Char_Status CS = _CS;
        Animator animator = CS.getAnimator();
